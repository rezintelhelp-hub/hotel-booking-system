    ...
    private function get_page_title_subtitle() {
        ...
        if ($page_data === false) {
            ...
            if (!is_wp_error($response)) {
                ...
                $page_data['page'] = $ws['page-attractions'] ?? array();
                $hdr = $ws['header'] ?? array();
