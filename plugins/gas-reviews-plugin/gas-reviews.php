    ...
    public function reviews_shortcode($atts) {
        ...
        <div class="gas-reviews-inner" style="width:100%; box-sizing:border-box;">
            <style>
                ...
                .gas-review-slider-card { background:<?php echo $card_bg; ?>; color:<?php echo $text; ?>; border-radius:<?php echo $card_radius; ?>px; padding:20px; height:298px; display:flex; flex-direction:column; border:1px solid rgba(255,255,255,0.08); }
