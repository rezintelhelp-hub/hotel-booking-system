...
const PURPOSES = Object.freeze({
  ...
  CAPTURE_CARD: 'capture_card',             // guest lands on card-capture page to add card to a booking
  UPSELL_PAY: 'upsell_pay'                  // guest lands on upsell-pay page to charge a fresh card for an add-on
});
...
const DEFAULT_TTL_SEC = {
  ...
  capture_card: 60 * 60 * 24 * 7,      // 7d — short-lived by design; operator can resend
  upsell_pay: 60 * 60 * 24 * 14        // 14d — upsells often relate to a specific stay date
};
