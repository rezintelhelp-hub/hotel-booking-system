...
function developer_get_api_settings() {
    ...
    $result = array(
        ...
        'usp_item_1_title' => $website_usp['item-1-title'] ?? '',
        ...
        'usp_item_2_title' => $website_usp['item-2-title'] ?? '',
        ...
        'usp_item_3_title' => $website_usp['item-3-title'] ?? '',
        ...
        'usp_item_4_title' => $website_usp['item-4-title'] ?? '',
        ...
        'usp_item_5_title' => $website_usp['item-5-title'] ?? '',
        ...
        'usp_item_6_title' => $website_usp['item-6-title'] ?? '',
