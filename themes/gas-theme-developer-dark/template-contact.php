...
/* Map card */
.gas-contact-map-frame { border-radius: 12px; overflow: hidden; border: 1px solid var(--developer-border, #e2e8f0); }
.gas-contact-map-frame iframe { width: 100%; height: 300px; border: 0; display: block; }
