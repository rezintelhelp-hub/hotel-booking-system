...
$section_positions = array(
    ...
    // Custom Sections — opt-in SB block on home page (Steve 2026-09-18).
    // Only rendered when custom_sections_enabled=true.
...
<style>
/* Mobile hero swap — Steve 2026-09-09. Desktop hero image → phone-specific
   image at ≤600px. Applied to every hero-bg surface on the homepage. */
...
<section class="developer-hero" <?php if ($hero_background_type === 'slider') : ?>data-slider-duration="<?php echo esc_attr($hero_slider_duration); ?>" data-slider-transition="<?php echo esc_attr($hero_slider_transition); ?>"<?php endif; ?>>
    ...
    <div class="developer-hero-content<?php echo $hero_align_class; ?>"<?php echo $hero_align_style; ?>>
        ...
        <?php
        // Steve 2026-08-15 — see developer-light for full note.
...
<section class="developer-section developer-wrap" style="background: <?php echo esc_attr($wrap_bg); ?>; color: <?php echo esc_attr($wrap_text_color); ?>;">
    <div class="developer-container">
        <?php // Top-heading layouts: emit h2 above the wrap block, full-width. ?>
        ...
        <div class="developer-wrap-content" style="overflow: hidden;">
            ...
            <?php if ($has_media || $has_card) : ?>
                <div class="developer-wrap-media-col" style="float: <?php echo esc_attr($wrap_media_position); ?>; width: <?php echo $wrap_media_width; ?>%; margin: 0 <?php echo $wrap_media_position === 'right' ? '0 1.5rem 1.5rem' : '1.5rem 1.5rem 0'; ?>; max-width: 100%;">
                    <?php if ($has_media) :
                        // Slider opt-in (2026-09-10). Same logic as developer-light.
                    ...
                    <?php endif; ?>
                    <?php if ($has_card) : ?>
                        <div class="developer-wrap-card" style="<?php echo $has_media ? 'margin-top: 1rem; ' : ''; ?>padding: 1.25rem; background: rgba(255,255,255,0.05);">
                            <?php if ($card_image) : ?>
