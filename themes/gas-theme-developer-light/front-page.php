        ...
        <div style="position: relative; padding: 0 60px;"><div style="overflow: hidden;">
            <div id="gas-repuso-slider" style="display: flex; transition: transform 0.5s ease;">
                ...
                <div class="gas-review-card-cell">
                    <div style="background: <?php echo esc_attr($reviews_card_bg); ?>; border-radius: <?php echo esc_attr($card_radius); ?>px; padding: 20px; height: 305px; display: flex; flex-direction: column; border: 1px solid rgba(255,255,255,0.08);">
