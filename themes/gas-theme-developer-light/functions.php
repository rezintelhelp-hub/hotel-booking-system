...
function developer_get_api_settings() {
    ...
    $result = array(
        ...
        'usp_item_1_display_mode' => $website_usp['item-1-display-mode'] ?? (!empty($website_usp['item-1-icon']) ? 'icon' : (!empty($website_usp['item-1-image-url']) ? 'image' : 'icon')),
        ...
        'usp_item_2_display_mode' => $website_usp['item-2-display-mode'] ?? (!empty($website_usp['item-2-icon']) ? 'icon' : (!empty($website_usp['item-2-image-url']) ? 'image' : 'icon')),
        ...
        'usp_item_3_display_mode' => $website_usp['item-3-display-mode'] ?? (!empty($website_usp['item-3-icon']) ? 'icon' : (!empty($website_usp['item-3-image-url']) ? 'image' : 'icon')),
        ...
        'usp_item_4_display_mode' => $website_usp['item-4-display-mode'] ?? (!empty($website_usp['item-4-icon']) ? 'icon' : (!empty($website_usp['item-4-image-url']) ? 'image' : 'icon')),
        ...
        'usp_item_5_display_mode' => $website_usp['item-5-display-mode'] ?? (!empty($website_usp['item-5-icon']) ? 'icon' : (!empty($website_usp['item-5-image-url']) ? 'image' : 'icon')),
        ...
        'usp_item_6_display_mode' => $website_usp['item-6-display-mode'] ?? (!empty($website_usp['item-6-icon']) ? 'icon' : (!empty($website_usp['item-6-image-url']) ? 'image' : 'icon')),
