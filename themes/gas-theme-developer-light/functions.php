...
function developer_developer_custom_css() {
    ...
    echo '<style id="developer-custom-css">
        ...
        /* Button Size — Web Builder Styles section, three-tier select.
           Applies to .developer-btn (theme buttons) AND .gas-view-btn
           ("View & Book" room cards, generated by the gas-booking plugin)
           so size stays consistent everywhere on the public site. */
        .developer-btn,
        .gas-view-btn,
        .gas-row-view-btn {
